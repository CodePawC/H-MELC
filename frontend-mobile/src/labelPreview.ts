...
import type { AssetPrintLabelPayload, JcPrinterElement } from './types'
...
export async function renderLabelPreview(canvas: HTMLCanvasElement, payload: AssetPrintLabelPayload): Promise<string> {
